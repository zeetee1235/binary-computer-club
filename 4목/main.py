...
def gameWonAnimation(board):
    win_image = large_font.render('빨강 Win', True, RED)
    DISPLAYSURF.blit(win_image, win_image.get_rect(centerx=WINDOWWIDTH // 2, centery=WINDOWHEIGHT // 2))
