    ...
    while not done:
        ...
        for event in pygame.event.get():
            ...
            if not game_over: 
                ...
                if game_over == X_WIN:
                    game_over_image = large_font.render('X wins', True, YELLOW)
                elif game_over == O_WIN:
                    game_over_image = large_font.render('O wins', True, YELLOW)
                else:
                    game_over_image = large_font.render('Draw', True, YELLOW)
